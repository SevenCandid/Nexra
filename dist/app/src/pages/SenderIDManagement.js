...
const statusMeta = (status) => {
    ...
    if (normalized === 'approved') return { label: 'Approved âœ…', variant: 'success' };
    if (normalized === 'need_verification') return { label: 'Need Verification ðŸŸ¡', variant: 'warning' };
    if (normalized === 'rejected') return { label: 'Rejected âŒ', variant: 'error' };
        ...
        return html`
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                <div className="p-3 rounded-2xl bg-gray-50 dark:bg-midnight-900/40 border border-gray-100 dark:border-midnight-800">
                    ...
                    <p className="text-xs text-gray-500 dark:text-midnight-500">${requester.email || 'No email'}${requester.phone_number ? ` â€¢ ${requester.phone_number}` : ''}</p>
                ...
                <div className="p-3 rounded-2xl bg-gray-50 dark:bg-midnight-900/40 border border-gray-100 dark:border-midnight-800">
                    ...
                    <p className="text-xs text-gray-500 dark:text-midnight-500">${org.plan_name || 'No plan'}${org.slug ? ` â€¢ ${org.slug}` : ''}</p>
                </div>
                <div className="p-3 rounded-2xl bg-gray-50 dark:bg-midnight-900/40 border border-gray-100 dark:border-midnight-800">
