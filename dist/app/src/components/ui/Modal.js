...
export const Modal = ({ isOpen, onClose, title, children }) => {
    ...
    const modal = html`
        <div className="fixed inset-0 z-[1000] flex items-start justify-center p-4 sm:p-6 pt-6 pb-6 overflow-x-hidden overflow-y-auto outline-none focus:outline-none">
            <div 
