    ...
    return html`
        <div className="space-y-6 fade-in">
            <div className="flex flex-col gap-4">
                <div className="flex flex-nowrap items-center gap-2 overflow-x-auto pb-1 custom-scrollbar w-full">
                    <${Button} variant="primary" className="shrink-0 rounded-xl px-3 py-2 shadow-glow" onClick=${() => window.location.hash = '/campaigns/create'}>
                        <${Icon} name="plus" size=${14} className="mr-1.5" />
                        <span className="text-[11px] font-bold whitespace-nowrap">New Campaign</span>
                    </${Button}>
                    <${Button} variant="secondary" className="shrink-0 rounded-xl px-3 py-2 bg-gray-50 dark:bg-midnight-800" onClick=${() => window.location.hash = '/contacts'}>
                        <${Icon} name="users" size=${14} className="mr-1.5 text-gray-500" />
                        <span className="text-[11px] font-bold text-gray-700 dark:text-gray-200 whitespace-nowrap">Contacts</span>
                    </${Button}>

                    ${dateRange === 'custom' && html`
                        <div className="flex items-center gap-1 bg-gray-50 dark:bg-midnight-800 border border-gray-200 dark:border-midnight-700 px-2 py-1 rounded-xl shrink-0">
                            <input 
                                type="date" 
                    ...
                    <select 
                        ...
                        className="shrink-0 bg-gray-50 dark:bg-midnight-800 border border-gray-200 dark:border-midnight-700 text-gray-700 dark:text-gray-300 text-[11px] font-bold rounded-xl px-3 py-2 outline-none appearance-none cursor-pointer pr-8 relative min-w-[100px]"
                        style=${{
